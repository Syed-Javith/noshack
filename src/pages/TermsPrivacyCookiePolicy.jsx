  ...
  return (
    <div id="top" className="privacy-policy">
      <div className='container'>
        ...
        <List list={cookies} />
        <h3>USE OF DATA:  </h3>
        <p>Noshack Solutions uses the collected data for various purposes:</p>
        <List list={useOfData} />
        ...
        <p>The name and contact information for the Grievance Officer are shown below in compliance with the Information Technology Act of 2000 and the Information Technology (Reasonable Security Practices and Procedures And Sensitive Personal Data or Information) Rules, 2011:</p>
        <h3>ADDRESS:</h3>
        <p>GRIEVANCE CELL <br /> OFFICE OF
          THE PRINCIPAL CHIEF COMMISSIONER OF INCOME TAX 121, <br /> MAHATMA GANDHI ROAD <br /> NUNGAMBAKKAM <br /> CHENNAI-600034</p>
        <h3>CHANGE OF PRIVACY POLICY:</h3>
        <ContentList content={changeOfPrivacyPolicy} />
        <h3>CONTACT US:</h3>
        <p>If you have any questions about this Privacy Policy, please contact us by email: <a style={{ color: "white" }} href="mailto:admin@noshack.com"> admin@noshack.com</a>.</p></div>
    </div>
  )
}
