...
export const personallyIdentifiable = [
   <li>Email address</li>,
...
export const introPara = [
    <p>Welcome to Noshack Solutions Private Limited.</p>,
    <p>Noshack Solutions (“us”, “we”, or “our”) operates noshack.com and noshack app and noshack.app (hereinafter referred to as “Service”).</p>,
    <p>Our Privacy Policy governs your visit to noshack.com, and explains how we collect, safeguard and disclose information that results from your use of our Service.</p>,
...
export const definitionPara = [
    <p>Service means the noshack.com website as well as applications operated by Noshack Solutions.</p>, 
    ...
    <p>Data Processor (Service Provider) means any natural or legal person who processes the data on behalf of the Data Controller. We may use the services of various Service Providers in order to process your data more effectively.</p>,
...
export const tranferOfDataPara = [
   ...
   <p>Noshack Solutions will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
]

export const cookiePara = [
...
export const dataProtection = [
      ...
      <p>If you wish to be informed what Personal Data we hold about you and if you want it to be removed from our systems, please email us at <a style={{color:"white"}} href="mailto:admin@noshack.com"> admin@noshack.com</a>.</p>,
...
Sustainable solutions are essential for any civilisation to survive and grow. We aim to build the same.`,

`Ensure digital inclusiveness#
Anyone must be able to reap the benefits of the Internet. Certainly a lengthy process, but certainly achievable.` , 

`Assurance of Reliability#
We wish to build the best possible solutions and provide the best value for our customers.`,

`Boost the growth of digital economy#
We are building solutions for people to make the best use of the digital economy.` , 

 `Extract the 'wow' out of simple#
Innovation at heart, value at scale.`
]